...
contains
    ...
    function test_dimensions() result(ierrcount)
        ...
        write(0,'(a)') '********************************************************************************'
        write(0,'(a)') '************ SMIOL_define_dim / SMIOL_inquire_dim unit tests *******************'
        write(0,'(a)') ''
        ...
        write(0,'(a)',advance='no') 'Handle undefined dimension (SMIOLf_inquire_dim): '
        ...
        write(0,'(a)',advance='no') 'Everything OK - unlimited dimension (SMIOLf_inquire_dim): '
        ...
        write(0,'(a)',advance='no') 'Everything OK - small non-record dimension (SMIOLf_inquire_dim): '
        dimsize = 0_SMIOL_offset_kind
        ...
        write(0,'(a)',advance='no') 'Everything OK - large non-record dimension (SMIOLf_inquire_dim): '
        dimsize = 0_SMIOL_offset_kind
